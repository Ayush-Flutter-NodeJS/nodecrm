  ...
  try {
    ...
    for (const form of formsRes.data.data) {
      ...
      while (nextPageUrl) {
          ...
          try {
            ...
            if (result.affectedRows > 0) {
              ...
              if (result.affectedRows === 1) {
                console.log(
                  `Inserted new lead: ${fields.email || fields.phone_number}`
                );
              } else {
                console.log(
                  `Updated existing lead: ${
                    fields.email || fields.phone_number
                  }`
                );
              }
            }
        ...
        console.log(
          `Form ${form.id}: Page ${pageCount} processed. Total so far: ${leadCount}`
        );
      ...
      console.log(
        `Finished form ${form.id}. Total inserted/updated: ${leadCount}`
      );
    }
  } catch (error) {
